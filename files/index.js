...
const UUID = process.env.UUID || '6d0aa248-6c57-4e1f-9acf-b5073d5e3814'; //若需要改UUID，需要在config.json里改为一致
const NEZHA_SERVER = process.env.NEZHA_SERVER || '';     
const NEZHA_PORT = process.env.NEZHA_PORT || '';                     // 哪吒端口为{443,8443,2096,2087,2083,2053}其中之一开启tls
const NEZHA_KEY = process.env.NEZHA_KEY || '';
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'choreow-6.huaiani.me';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiYTc1OTE1ZTdiMGFmZDIzZjBlNDdiYmQ1NjhiMTI5ZjEiLCJ0IjoiYzA2YTk4OTgtZGU2ZS00MDczLWEyMGQtZWQ5ZGM2ZTE4MTYxIiwicyI6Ik1HWmpaak14WldFdE5HWXdPQzAwWVdJeExXRmlPVFV0TldRM1pHRTNPVFJqWVdReCJ9';
